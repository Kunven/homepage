    ...
    <div className="bg-gradient-to-r from-red-600 to-orange-500">
      ...
      <div className="bg-gradient-to-r from-red-600 to-orange-500 m-5">
        ...
        <Card className="mt-5" id="aboutMe">          
          <CardBody className="content-center max-w-7xl mx-auto px-8 justify-center h-full">
            ...
            <div className="grid grid-cols-2  content-center mx-auto justify-center h-full">
              <p>I'm a very passionate developer. I have been tinkering with computers and software since basically forever, so I basically love what I do. That love and passion allows me to be very detailed when I write code to the company that I'm working for.</p>
            </div>        
          </CardBody>
        </Card>
      </div>      
